...
try {
    ...
    17. Si se pide algun descuento, buscalo en la tabla de Productos como porcentaje_descuento en la lista de productos y responde el precio original y el precio con descuento.
